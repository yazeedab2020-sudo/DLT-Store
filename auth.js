...
function renderAccountArea() {
    ...
    if (user) {
        ...
        container.innerHTML = `
            <a href="login.html" class="bg-neonGreen/10 text-neonGreen border border-neonGreen/30 px-3 py-1 rounded-lg text-xs md:text-sm hover:bg-neonGreen/20 transition">تسجيل الدخول</a>
        `;
    }
}
